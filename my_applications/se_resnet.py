...
from my_applications.resnet50 import preprocess_input
#from my_applicationss.imagenet_utils import decode_predictions
import keras.backend as K

from my_applications.se import squeeze_excite_block
...
def _create_se_resnet(classes, img_input, include_top, initial_conv_filters, filters,
    ...
    x = Conv2D(initial_conv_filters, (7, 7), padding='same', use_bias=False, strides=(2, 2),
               kernel_initializer='he_normal', kernel_regularizer=l2(weight_decay), name='conv_first_convert')(img_input)
