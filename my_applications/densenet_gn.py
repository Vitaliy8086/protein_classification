...
from my_applications import imagenet_utils
from my_applications.imagenet_utils import decode_predictions
from my_applications.imagenet_utils import _obtain_input_shape
import my_applications.group_norm as GN
...
def transition_block(x, reduction, name):
    ...
    x = GN.GroupNormalization(axis=bn_axis,  name=name + '_gn')(x)
...
def conv_block(x, growth_rate, name):
    ...
    #                               epsilon=1.001e-5,
    #                               name=name + '_0_bn')(x)
    x1 = GN.GroupNormalization(axis=bn_axis,  name=name + '_0_gn')(x)
    ...
    #                              name=name + '_1_bn')(x1)
    x1 = GN.GroupNormalization(axis=bn_axis,  name=name + '_1_gn')(x1)
...
def DenseNet(blocks,
    ...
    x = GN.GroupNormalization(axis=bn_axis,  name='conv1/gn')(x)
    ...
    x = GN.GroupNormalization(axis=bn_axis,  name='gn')(x)
